 ...
 */
fun <T : Any> Fragment.autoCleared(): AutoClearedValue<T> = AutoClearedValue<T>(this)
 ...
 * Creates an [AutoClearedValue] associated with this fragment.
 */
fun <T : Any> AppCompatActivity.autoCleared(): AutoClearedActivityValue<T> =
    AutoClearedActivityValue<T>(this)